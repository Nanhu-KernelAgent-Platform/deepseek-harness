...
export const en = {
  ...
  modelReasoningEfforts: 'Supported reasoning levels',
  modelReasoningEffortsHint: 'Selected levels appear in the model picker and are sent using the same OpenAI-style value.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelReasoningEffortsHint: '选中的档位会出现在模型选择器中，并按 OpenAI 同名值发送。',
